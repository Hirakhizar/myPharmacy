...
<body>
            ...
            <div class="container form-container">
                <div class="row mt-3">
                    <div class="col-md-12 mb-3 form-group" style="text-align: center">
                        <h2 class="text" style="color:#7172b9;">Purchase Medicine</h2>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="medicineTableBody">
                                    ...
                                    <tr data-id="{{ $medicine->id }}">
                                        ...
                                        <td>
                                            <form action="{{ url('addToCart', $medicine->id) }}" method="POST" id="form_{{ $medicine->id }}">
                                                @csrf
    ...
    <script>
        ...
        document.getElementById('searchManufacturerInput').addEventListener('input', function() {
            ...
            rows.forEach(row => {
                const manufacturerText = row.cells[2].textContent.toLowerCase();

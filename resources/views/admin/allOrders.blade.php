                ...
                <div class="search-container">
                    <div class="row" style="color: #7172b9">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="searchManufacturerInput" placeholder="Search by Customer">
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="medicineTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('order/itemsDetails',['id'=>$order->id]) }}" class='btn btn-secondary'><b>Detail</b></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>

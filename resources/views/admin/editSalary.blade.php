...
@include('admin.main_header')
        ...
        <div class="col-md-12 mt-2 mb-2">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h5>Update Member for Salary</h5>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="member_id" id="" class="form-control">
                            ...
                            <option value="{{$member->id }}" {{ $member->id==$salary->member_id ? 'selected' : '' }}>{{ $member->first_name.' '.$member->last_name  }}</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" id='dateInput' value={{ $salary->date }} name="date">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Total Salary</label>
                          <input type="text" class="form-control"value={{ $salary->totalSalary }} name="totalSalary">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Working Days</label>
                          <input type="text" class="form-control"value={{ $salary->workingDays }}  name="workingDays">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 mt-2">
                        ...
                        <a href={{url('member/salary')}} class="btn btn-danger">Cancel</a>
                      </div>
                    </div>
                 </form>
                </div>
  ...
  <script>
   ...
   document.getElementById('attendenceForm').addEventListener('submit', function(event) {
    ...
    fetch('{{ url('member/salary/update',['id'=>$salary->id]) }}', {
        method: 'POST',
        body: formData,
        headers: {

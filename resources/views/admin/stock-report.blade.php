      ...
      <div class="container mt-5 ">
        <div class="row">
          <div class="col-11 container mt-3">
            <div class="p-4 ">
                <p style="color: #778edd"><b style="font-size: 30px;">Stock</b> Report </p>            </div>
          </div>
        </div>
        ...
        <div class="row mt-5 mx-2">
          <div class="col-12 ">
            <div class='card'>
                <div class="card-body" id="pdf-content" style="background-color: #f1f1f1; border-radius: 8px;  border: 1px solid #ccc; ">
              <table class="table table-striped table-hover" id="purchaseTable">
                <thead>
                  <tr>
                    <th style="color: #778edd">Medicine </th>
                    <th style="color: #778edd">Stock</th>
                    <th style="color: #778edd">Status</th>
                    <th style="color: #778edd">Expire Date</th>
                  </tr>
                </thead>
                <tbody>

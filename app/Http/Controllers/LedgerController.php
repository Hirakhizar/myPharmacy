...
//         $user = Auth::user();
//         if($user->usertype == 'admin'){
//             $manufactures = Manufacturer::find($id);
//             $medicine = Medicine::where('manufacturer_id',$id)->get();
//             $total = 0;
//            foreach($medicine as $med){
//             $mult=$med->price *$med->stock;
//             $total+=$mult;
//            }
//             return view('admin.manufacture_payment',compact('user','manufactures','total'));
//         }
//     }
...
//         if ($manufacturer) {
//             $medicines = Medicine::where('manufacturer_id', $id)->get();

//             // Calculate the total payment amount for the medicines
//             $totalPayment = 0;
//             foreach ($medicines as $medicine) {
//                 $totalPayment += $medicine->price * $medicine->stock;
//             }

//             $manufacturePayment = new ManufacturerPayment();
//             $manufacturePayment->manufacturer_id = $manufacturer->id;
//             $manufacturePayment->method = $request->method;
//             $manufacturePayment->amount = $request->amount;
//             $manufacturePayment->date = $request->date;

//             // Calculate remaining amount
//             $remainingAmount = $totalPayment - $manufacturer->remaining_amount;

//             if ($request->amount >= $remainingAmount) {
//                 $manufacturePayment->status = "completed";
//                 $manufacturer->remaining_amount = 0; // Payment completed, remaining amount is 0
//             } else {
//                 $manufacturePayment->status = "incomplete";
//                 $manufacturer->remaining_amount -= $request->amount;
//             }

//             $manufacturePayment->save();
//             $manufacturer->save();
